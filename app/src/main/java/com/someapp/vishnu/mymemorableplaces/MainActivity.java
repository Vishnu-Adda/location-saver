...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = this.getSharedPreferences("com.someapp.vishnu.mymemorableplaces", Context.MODE_PRIVATE);
        ...
        ListView listView = findViewById(R.id.memorableListView);
